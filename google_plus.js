...
var sendTweet = "img/twitter_input_3_create_post.png";

// result "slots" (so you can see what the script sees)
var site = "img/google_1_initial_page.png";
var result = "img/google_2_logged_in.png";
var tweeting = "img/google_3_posting.png";
var completed = "img/google_4_completed_post.png";

// login details and tweet message contents
var googleusername = "rickyayoub";
var googlepassword = "ENTER YOUR TWITTER PASSWORD HERE";
var tweetMessage = "YO! This is an automated Google+ post via Sikuli-Spectre: https://github.com/vgmoose/sikuli-spectre. Let's change autonomous web scripting!";

page.viewportSize = { width: 800, height: 800 };

page.open('https://plus.google.com', function () {
          setTimeout(function(){
                     page.render(site);
